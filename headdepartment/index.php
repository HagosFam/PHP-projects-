...
<!-- begins the navigation -->
<?php include ("../includes/headerDep.php");?>
...
<div class="container">
      ...
      <a href="index.php?page=listStocks">List Stocks</a> <br>
          ...
          <div class="panel panel-primary">
            <div class="panel-heading" role="tab" id="headingFivee">
              <h4 class="panel-title">
                <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseFivee" aria-expanded="true"
								 aria-controls="collapseFivee"><span class="glyphicon glyphicon-user"></span>Manage Requests</a>
              </h4>
            </div>
            <div id="collapseFivee" class="panel-collapse collapse in  well" role="tabpanel" aria-labelledby="headingFivee">
              <div class="panel-body">

      <a href="index.php?page=requestDevice">Request Device</a>  <br>
  ...
  <div class="panel panel-primary">
   ...
   <div class="panel-body">
      <a href="index.php?page=MaintenaceRequest">Request For Maintenace</a>  <br>
    ...
    <div class="container-fluid">
      ...
      <p class=" text-center " style="padding-top:10px; font-size:18px;">&copy;<?php echo date("Y");?> &nbsp;
         <span  class="text-success" style="padding-top:10px; font-size:18px;">
          All rights Reserved. BY Fitsum Birhan SMS development Group</span>
      </p>
